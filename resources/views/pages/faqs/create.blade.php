        ...
        <div class="card-body">
            <form method="POST" action="{{ route('faqs.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="Title" class="form-control" name="title" placeholder="Title here.." value="{{ old('content') }}">
                </div>
                <div class="form-group">
                    <label class="text-muted" for="Body">Body</label>
                    <textarea name="body" id="Body"class="form-control" placeholder="Body here..">{{ old('content') }}</textarea>
                </div>
