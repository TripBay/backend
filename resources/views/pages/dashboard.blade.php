                                ...
                                <div class="card pb-3">
                                    ...
                                    <div class="list list-row">
                                        <div class="list-item " data-id="16">
                                            ...
                                            <div class="flex">
                                                <a href="music.detail.html" class="item-title text-color h-1x">AI Could Uber</a>
                                        ...
                                        <div class="list-item " data-id="5">
                                            ...
                                            <div class="flex">
                                                <a href="music.detail.html" class="item-title text-color h-1x">Google Analytics training</a>
                                                <div class="item-except text-muted text-sm h-1x">
                        ...
                        <div class="card">
                            ...
                            <table class="table table-theme v-middle m-0">
                                <tbody>
                                    <tr class=" " data-id="11">
                                        ...
                                        <td>
                                            <div class="avatar-group ">
                                                <a href="#" class="avatar ajax w-32" data-toggle="tooltip" title="Nisi">
                                                    <img src="{{ asset('assets/img/a10.jpg') }}" alt=".">
                                                </a>
                                                <a href="#" class="avatar ajax w-32" data-toggle="tooltip" title="Mi">
                                                    <img src="{{ asset('assets/img/a14.jpg') }}" alt=".">
                                                </a>
                                    ...
                                    <tr class=" " data-id="4">
                                        ...
                                        <td>
                                            <div class="avatar-group ">
                                                <a href="#" class="avatar ajax w-32" data-toggle="tooltip" title="Quis">
                          ...
                          20
                                    ...
                                    <tr class=" " data-id="5">
                                        ...
                                        <td>
                                            <div class="avatar-group ">
                                                <a href="#" class="avatar ajax w-32" data-toggle="tooltip" title="Fermentum">
                                                    <img src="{{ asset('assets/img/a7.jpg') }}" alt=".">
                                                </a>
                                                <a href="#" class="avatar ajax w-32" data-toggle="tooltip" title="Blandit">
                                    ...
                                    <tr class=" " data-id="12">
                                        ...
                                        <td>
                                            <div class="avatar-group ">
                                                <a href="#" class="avatar ajax w-32" data-toggle="tooltip" title="Proin">
                                                    <img src="{{ asset('assets/img/a9.jpg') }}" alt=".">
                                                </a>
                                                <a href="#" class="avatar ajax w-32" data-toggle="tooltip" title="Sociis">
                                                    <img src="{{ asset('assets/img/a4.jpg') }}" alt=".">
                                                </a>
                                                <a href="#" class="avatar ajax w-32" data-toggle="tooltip" title="Morbi">
                        ...
                        <div class="card flex">
                            ...
                            <div class="list list-row">
                                <div class="list-item " data-id="9">
                                    ...
                                    <div class="flex">
                                        <a href="music.detail.html" class="item-title text-color h-1x">Web App develop tutorial</a>
                                    </div>
                                    <div>
                                ...
                                <div class="list-item " data-id="20">
                                    ...
                                    <div class="flex">
                                        <a href="music.detail.html" class="item-title text-color h-1x">Netflix hackathon ios app</a>
                                    </div>
                                    <div>
                                        <span class="item-amount d-none d-sm-block text-sm text-muted">
                                        20
                                ...
                                <div class="list-item " data-id="3">
                                    ...
                                    <div class="flex">
                                        <a href="music.detail.html" class="item-title text-color h-1x">Html5 dashboard conference</a>
                                    </div>
                                    <div>
                                        <span class="item-amount d-none d-sm-block text-sm text-muted">
                                            50
                                ...
                                <div class="list-item " data-id="2">
                                    ...
                                    <div class="flex">
                                        <a href="music.detail.html" class="item-title text-color h-1x">Data analytics application</a>
                                    </div>
                                    <div>
                                        <span class="item-amount d-none d-sm-block text-sm text-muted">
                                        4
