        ...
        <ul class="nav navbar-menu order-1 order-lg-2">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-center mt-3 w animate fadeIn">
                    <div class="setting px-3">
                        ...
                        <div class="mb-3">
                            <a href="dashboard.html" class="btn btn-sm btn-white no-ajax mb-1">Default</a>
                            <a href="layout.a.html?bg" class="btn btn-sm btn-white no-ajax mb-1">A</a>
                            <a href="layout.b.html?bg" class="btn btn-sm btn-white no-ajax mb-1">B</a>
                        </div>
                        <div class="mb-2 text-muted">
                            <strong>Apps:</strong>
                        </div>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right w mt-3 animate fadeIn">
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="{{ route('profile.edit',auth()->user()->profile->id) }}">
